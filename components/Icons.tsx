...
// FIX: Defined Star as a React.FC to correctly handle props like 'key' when used in lists.
const StarIcon: React.FC<{ className?: string }> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 ${props.className}`}>
